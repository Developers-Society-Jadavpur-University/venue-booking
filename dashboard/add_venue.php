                                ...
                                <div class="page-wrapper">
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>Venue Creation</h4>
                                                        <span>Fill the following form to add a new venue to the database</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">Add New Venue</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="page-body">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Add New Venue</h5>
                                                        <span>Fill all details about venue and add all rooms it consists of</span>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="j-pro/php/action.php" method="post" class="j-pro" id="j-pro" novalidate="">
                                                                <div class="j-content">
                                                                    ...
                                                                    <div class="j-row">
                                                                        <div class="j-span6 j-unit">
                                                                            <div class="j-input">
                                                                                <label class="j-icon-left" for="venue-name">
                                                                                    <i class="icofont icofont-ui-user"></i>
                                                                                </label>
                                                                                <input type="text" id="venue-name" name="venue-name" placeholder="Venue Name">
                                                                                <span class="j-tooltip j-tooltip-right-top">Enter the Venue Name</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="j-span6 j-unit">
                                                                            <div class="j-input">
                                                                                <label class="j-icon-left" for="venue-capacity">
                                                                                    <i class="icofont icofont-ui-user"></i>
                                                                                </label>
                                                                                <input type="text" id="venue-capacity" name="venue-capacity" placeholder="Approx. Capacity">
                                                                                <span class="j-tooltip j-tooltip-right-top">Enter approximate capacity</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end name -->
                                                                    ...
                                                                    <div class="j-unit">
                                                                        <div class="j-input">
                                                                            <label class="j-icon-left" for="venue-location">
                                                                                <i class="icofont icofont-file-text"></i>
                                                                            </label>
                                                                            <textarea placeholder="Mention the approximate location of the venue (preferably with landmarks)" spellcheck="false" id="venue-location" name="venue-location"></textarea>
                                                                            <span class="j-tooltip j-tooltip-right-top">Enter approximate address of venue</span>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end message -->
                                                                ...
                                                                <!-- end /.content -->
                                                                <div class="j-footer">
                                                                    <button type="submit" class="btn btn-primary">Confirm Venue Addition</button>
                                                                </div>
                                                                <!-- end /.footer -->
                                                            </form>
                                                        </div>
                                        ...
                                        <div class="card" style="display:block;">
                                            <div class="card-header">
                                                <h5>Add the rooms under this venue</h5>
